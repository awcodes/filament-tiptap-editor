<button type="button"
    x-on:click="editor().chain().focus().unsetTextAlign().run()"
    :class="{ 'bg-gray-300 text-gray-900 dark:bg-gray-600 dark:text-gray-300': isActive('textAlign', updatedAt) }"
    @class([
