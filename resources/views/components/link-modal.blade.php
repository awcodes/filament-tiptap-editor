<div x-data="{
    ...
    toggleOpen(event) {
        ...
        $wire.setState(event.detail.href, event.detail.target, event.detail.rel);
    }
}"
    ...
    role="dialog"
    aria-modal="true"
    class="inline-block filament-tiptap-editor-modal">
    ...
    <div x-show="isOpen"
        ...
        <button x-on:click="isOpen = false; $wire.resetForm();"
            type="button"
            aria-hidden="true"
        ...
        <div x-show="isOpen"
            ...
            x-on:keydown.window.escape="isOpen = false; $wire.resetForm();"
            x-transition:enter="ease duration-300"
