...
import { CheckList, Lead } from "./extensions";
...
document.addEventListener("alpine:init", () => {
    Alpine.data("tiptap", ({ state, buttons = "", blocks = [] }) => {
        ...
        return {
            ...
            updatedAt: Date.now(),
            getExtensions() {
                let exts = [Document, Text, Paragraph];
                ...
                if (this.buttons.includes("superscript"))
                ...
                if (
                    this.buttons.includes("orderedList") ||
                    this.buttons.includes("unorderedList")
                ) {
                    if (this.buttons.includes("orderedList"))
                        exts.push(OrderedList);
                    if (this.buttons.includes("unorderedList"))
                ...
                if (
                    this.buttons.includes("h1") ||
                    this.buttons.includes("h2") ||
                    this.buttons.includes("h3") ||
                    this.buttons.includes("h4") ||
                    this.buttons.includes("h5") ||
                    this.buttons.includes("h6")
                ) {
                    let levels = [];
